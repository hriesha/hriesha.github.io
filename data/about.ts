// Edit this content to update your About page
export const aboutContent = {
  ...
  paragraphs: [
    ...
    `The most recent thing I’ve built is AgentReady, which audits e-commerce catalogs for how well AI shopping agents can read them. Before that I did quantitative research at QiCap on Indian equities, building signals and a mean-reversion engine around a divergence I’d spotted in the market. Earlier projects include HeartBeats and IT-Mobile, an offline Wi-Fi diagnostics tool with speech accessibility that won awards at DubHacks.`,
